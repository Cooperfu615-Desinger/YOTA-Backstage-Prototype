...
const menuItems: MenuItem[] = [
  { 
    ...
    children: [
      ...
      { path: '/dashboard/operations', title: '營運數據', icon: 'pi-dollar' },
      { path: '/dashboard/monitoring', title: '玩家監控', icon: 'pi-eye' },
    ]
  },
  { 
    path: '/operators', 
  ...
  { 
    ...
    icon: 'pi-palette',
    children: [
      { path: '/layout/overview', title: '版面總覽', icon: 'pi-chart-pie' },
  ...
  { 
    ...
    icon: 'pi-play',
    children: [
      { path: '/games/overview', title: '遊戲總覽', icon: 'pi-chart-pie' },
