<template>
  <div class="p-6 space-y-6">
    ...
    <div class="flex items-center gap-2 text-sm text-surface-400">
      ...
      <span>></span>
      <span class="text-white font-medium">推廣總覽</span>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card class="bg-surface-800/50 border border-surface-700">
            <template #content>
                <div class="flex flex-col gap-2">
                    <span class="text-surface-400 text-sm">今日參與人數</span>
                    <span class="text-2xl font-bold text-white">1,245</span>
        ...
        <Card class="bg-surface-800/50 border border-surface-700">
             <template #content>
                <div class="flex flex-col gap-2">
                    <span class="text-surface-400 text-sm">今日發放金額</span>
                    <span class="text-2xl font-bold text-yellow-400">$ 458,200</span>
                    <span class="text-green-400 text-xs flex items-center gap-1">
        ...
        <Card class="bg-surface-800/50 border border-surface-700">
             <template #content>
                <div class="flex flex-col gap-2">
                    <span class="text-surface-400 text-sm">待審核申請</span>
                    <span class="text-2xl font-bold text-orange-400">23</span>
                    <span class="text-surface-500 text-xs">需立即處理</span>
                </div>
            </template>
        </Card>
        <Card class="bg-surface-800/50 border border-surface-700">
             <template #content>
                <div class="flex flex-col gap-2">
                    <span class="text-surface-400 text-sm">進行中活動</span>
                    <span class="text-2xl font-bold text-blue-400">8</span>
                    <span class="text-surface-500 text-xs">全部正常運行</span>
                </div>
            </template>
        </Card>
    </div>
    ...
    <Card class="bg-surface-800/50 border border-surface-700">
        ...
        <template #content>
             <DataTable :value="recentActivities" stripedRows class="p-datatable-sm" :pt="{ table: { class: 'min-w-full' }, tbody: { class: 'text-surface-300' } }">
